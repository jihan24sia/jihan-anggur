                    ...
                    <form action="{{ route('user.update', $dataUser->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="role" id="role"
                                    ...
                                    <option value="Super Admin"
                                        {{ old('role', $dataUser->role) == 'Super Admin' ? 'selected' : '' }}>Super
                                        Admin</option>
                                    <option value="Pelanggan"
                                        {{ old('role', $dataUser->role) == 'Pelanggan' ? 'selected' : '' }}>Pelanggan
                                    </option>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($dataUser->profile_picture)
                                <img src="{{ asset('storage/' . $dataUser->profile_picture) }}" width="70"
                                    height="70" class="rounded mb-2" style="object-fit: cover;">
                            @endif
